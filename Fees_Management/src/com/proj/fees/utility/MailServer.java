...
public class MailServer {
	...
	public void sendMail(String recepient, String subjectLine, String messageContent) throws MessagingException {
		...
		System.out.println(
				"recepient:" + recepient + ";subjectLine:" + subjectLine + ";messageContent:" + messageContent);
	...
	private Message prepareMessage(Session session, String myAccEmail, String recepient, String subjectLine,
